...
**研究工具：**
- web_search：搜索关键词、趋势、讨论
- web_fetch：抓取文章/文档原文
- GitHub API：获取仓库信息（star数、README、提交记录）
...
├── REFERENCES.md         ← 参考资料（来源、研究记录）
└── references/
    ├── case_study.md    ← 本次创作的灵感来源与研究记录
    └── external_links.md ← 所有有价值的外部参考链接
```
...
2. **初始化并推送**：
   ...
   git init
   git add SKILL.md README.md 创作日志.md references/
   git commit -m "{版本描述}"
